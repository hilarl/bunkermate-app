          ...
          <div className={classes.innerContent}>
            <Grid container spacing={3} className={classes.orderforms}>
              <Grid item xs={12} sm={6}>
                ...
                <p style={{fontSize: '16px'}}><strong>Pickup:</strong> Breda Harbour, Breda, Netherlands</p>
                <p style={{fontSize: '16px'}}><strong>Dropoff:</strong> Rotterdam Harbour, Rotterdam, Netherlands</p>
                <Paper className={classes.paper}>
                    <Link style={{textDecoration: 'none'}} to="/home/">
                        <Button className={classes.searchAgainButton} size="large" variant="contained" color="primary">
                            Search Again
                        </Button>
                    </Link>
                </Paper>
